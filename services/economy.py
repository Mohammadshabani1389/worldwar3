...
def _default_bank_config():
    ...
    for level in range(1, 101):
        levels[str(level)] = {
            ...
            "required_hq_level": 1,
            "deposit_capacity": 0,
            "deposit_hourly_max_amount": 0,
            "deposit_hourly_profit_percent": 0,
            "withdraw_enabled": True,
            "loan": {"min_amount": 0, "max_amount": 0, "min_interest_percent": 0, "max_interest_percent": 0, "min_installments": 1, "max_installments": 1, "min_term_days": 1, "max_term_days": 1, "max_active_loans": 1},
            "tax_min": 0,
            "tax_max": 0,
            "active": True,
        }
    return {"max_level": 100, "population_initial": 1_000_000, "population_growth_per_hour": 0, "levels": levels, "investments": [], "loan": {"min_amount": 0, "max_amount": 0, "min_interest_percent": 0, "max_interest_percent": 0, "min_installments": 1, "max_installments": 1, "min_term_days": 1, "max_term_days": 1, "max_active_loans": 1}, "instant_finish_uranium_per_hour": 0}
...
def get_bank_config(session):
    ...
    cfg.setdefault("max_level",100); cfg.setdefault("population_initial",1_000_000); cfg.setdefault("population_growth_per_hour",0); cfg.setdefault("investments",[]); cfg.setdefault("loan", {"max_amount":0,"interest_percent":0,"term_hours":0,"installments":1}); cfg.setdefault("instant_finish_uranium_per_hour",0); cfg.setdefault("levels",{})
    ...
    for level in range(1,101):
        ...
        current.setdefault("deposit_hourly_max_amount", 0)
        current.setdefault("deposit_hourly_profit_percent", 0)
        loan_defaults = {"min_amount": 0, "max_amount": 0, "min_interest_percent": 0, "max_interest_percent": 0, "min_installments": 1, "max_installments": 1, "min_term_days": 1, "max_term_days": 1, "max_active_loans": 1}
...
def bank_deposit_hourly_max(session,country):
    return float(bank_level_config(session,max(1,int(country.bank_level or 1))).get("deposit_hourly_max_amount",0) or 0)
