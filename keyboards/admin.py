...
def golden_box_detail_keyboard(k):
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton('🎁 مقدار جوایز',callback_data=f'owner:golden_box_reward:{k}')],
        [InlineKeyboardButton('💰 هزینه‌های ارتقا',callback_data=f'owner:golden_box_cost:{k}')],
        [InlineKeyboardButton('⏱ زمان ارتقا',callback_data=f'owner:golden_box_edit:{k}:upgrade_time')],
