...
def central_bank_deposit_keyboard():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📥 دریافت سپرده", callback_data="bank:withdraw_principal", style="primary")],
        [InlineKeyboardButton("💹 دریافت سود سپرده", callback_data="bank:withdraw_profit", style="primary")],
...
def central_bank_my_loans_keyboard():
    return InlineKeyboardMarkup([[InlineKeyboardButton("🔙 برگشت", callback_data="bank:loans")]])
